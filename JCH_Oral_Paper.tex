...
\section{Theory}
    ...
    \subsection{A Vector Portal}
        ...
        \eqref{eq:1} becomes $|D_{\mu}\phi|^2 - m_{\phi}^2\phi^{*}\phi$. For the
        purposes of this paper the choice is arbitrary.} 
        \\
        \begin{figure}[ht]
            \centering
...
\section{Event Selection}
    ...
    \subsection{Signal Selection}
        ...
        \begin{figure}[ht]%
            \centering
            \subfloat[Energy in ECal in $\Delta R < 0.3$ Cone]{{\includegraphics[width=0.45\textwidth]{Figures/acceptSelection_trkCaloEMDepDR03.pdf} }}%
            \subfloat[Energy in HCal in $\Delta R < 0.3$ Cone]{{\includegraphics[width=0.45\textwidth]{Figures/acceptSelection_trkCaloHadDepDR03.pdf} }}%
...
\section{Results}
    ...
    \begin{figure}[!htbp]%
        \centering
        \subfloat[Invariant Mass of Muon-Track Pair]{{\includegraphics[width=0.45\textwidth]{Figures/trkHCalLow3GeVECalLow3GeVOneMuTrkMatch3Miss_invMassMuonTrack.pdf} }}%
        \subfloat[$\eta$ Distribution for Tracks]{{\includegraphics[width=0.45\textwidth]{Figures/trkHCalLow3GeVECalLow3GeVOneMuTrkMatch3Miss_trkEta.pdf} }}%
