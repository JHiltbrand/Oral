...
\section{The CMS Detector}
    ...
    \begin{figure}[ht]
        \begin{center}
            \includegraphics[width=0.9\linewidth]{CMS_Detector_Cutaway.png}
        \end{center}
...
\section{Event Selection}
    ...
    \subsection{Quality Selection}
        ...
        \begin{figure}[ht]
            \begin{center}
                \includegraphics[scale=0.5]{CMS_rz_Cutaway.png}
            \end{center}
        ...
        \begin{figure}[ht]
            \begin{center}
                \includegraphics[width=0.5\textwidth]{acceptSelection_trkfitChi2.png}
            \end{center}
...
%    >= 1 muons with$\ p_{T}$ > 26                                                                                                                                                                                                                        & 1079212 $\pm$ 1040.0              \\ 
%    >= 1 muons with |$\eta$| < 2.1                                                                                                                                                                                                                       & 1079212 $\pm$ 1040.0              \\ 
%    >= 1 tracks with$\ p_{T}$ > 26                                                                                                                                                                                                                       & 1079207 $\pm$ 1040.0              \\ 
%    >= 1 tracks with |$\eta$| < 2.1                                                                                                                                                                                                                      & 1079206 $\pm$ 1040.0              \\ 
%    >= 1 muon-tracks with sqrt ((muon.energy + track.energyOfMuon) * (muon.energy + track.energyOfMuon) - (muon.px + track.px) * (muon.px + track.px) - (muon.py + track.py) * (muon.py + track.py) - (muon.pz + track.pz) * (muon.pz + track.pz)) < 120 & 1079206 $\pm$ 1040.0              \\ 
%    >= 1 muon-tracks with sqrt ((muon.energy + track.energyOfMuon) * (muon.energy + track.energyOfMuon) - (muon.px + track.px) * (muon.px + track.px) - (muon.py + track.py) * (muon.py + track.py) - (muon.pz + track.pz) * (muon.pz + track.pz)) > 60  & 564894 $\pm$ 752.0                \\ 
    Basic Acceptance                                    & 564894 $\pm$ 752.0                \\
%    >= 1 tracks with (trackIsoNoPUDRp3 /$\ p_{T}$) < 0.1                                                                                                                                                                                                 & 564427 $\pm$ 751.0                \\ 
%    >= 1 tracks with |$\eta$| < 1.42\ \vert\ |$\eta$| > 1.65                                                                                                                                                                                             & 554333 $\pm$ 745.0                \\ 
%    >= 1 tracks with |$\eta$| < 0.15\ \vert\ |$\eta$| > 0.35                                                                                                                                                                                             & 522933 $\pm$ 723.0                \\ 
%    >= 1 tracks with |$\eta$| < 1.55\ \vert\ |$\eta$| > 1.85                                                                                                                                                                                             & 501241 $\pm$ 708.0                \\ 
%    >= 1 tracks with chi2 > 4 \& chi2 < 60                                                                                                                                                                                                               & 492776 $\pm$ 702.0                \\ 
%    >= 1 muons with |$\eta$| < 1.42\ \vert\ |$\eta$| > 1.65                                                                                                                                                                                              & 488032 $\pm$ 699.0                \\ 
%    >= 1 muons with |$\eta$| < 0.15\ \vert\ |$\eta$| > 0.35                                                                                                                                                                                              & 482511 $\pm$ 695.0                \\ 
%    >= 1 muons with |$\eta$| < 1.55\ \vert\ |$\eta$| > 1.85                                                                                                                                                                                              & 478761 $\pm$ 692.0                \\ 
    Quality Selection                                   & 478761 $\pm$ 692.0                \\
%    == 1 eventvariables with muTrkMatches == 1                                                                                                                                                                                                           & 35521 $\pm$ 188.0                 \\ 
%    < 2 tracks with$\ p_{T}$ > 0                                                                                                                                                                                                                         & 34634 $\pm$ 186.0                 \\ 
%    >= 1 tracks with caloHadDRp3 < 3.0                                                                                                                                                                                                                   & 14408 $\pm$ 120.0                 \\ 
%    >= 1 tracks with caloEMDRp3 < 3.0                                                                                                                                                                                                                    & 11635 $\pm$ 108.0                 \\ 
